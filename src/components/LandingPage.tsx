      ...
      <div className="border-t border-gray-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Join our network of shipping partners and help deliver products to customers nationwide. Expand your delivery business with us.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                to="/shipping/register"
                className="px-8 py-3 bg-orange-600 text-white rounded-lg font-semibold hover:bg-orange-700 transition-colors inline-flex items-center justify-center"
              >
